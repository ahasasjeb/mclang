...
fn registered_triggers(text: &str) -> Vec<(String, String)> {
...
fn trigger_fields(text: &str) -> BTreeMap<String, String> {
...
fn trigger_codec_region(text: &str) -> Option<&str> {
...
/// 或 `group(` 的左括号处停下。
fn codec_before(text: &str, index: usize) -> &str {
...
fn codec_kind(codec: &str) -> &'static str {
