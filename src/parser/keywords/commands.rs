...
pub(crate) fn command_value(value: &str) -> Option<&'static str> {
    match value {
        ...
        "display_name" | "displayname" | "显示名" => Some("display_name"),
        ...
        "runthat" | "运行所指" => Some("runthat"),
        "runfailed" | "运行失败项" => Some("runfailed"),
        "verify" | "验证" => Some("verify"),
        "locate" | "定位" => Some("locate"),
        "resetclosest" | "重置最近" => Some("resetclosest"),
        "resetthese" | "重置附近" => Some("resetthese"),
        "resetthat" | "重置所指" => Some("resetthat"),
        "clearthat" | "清理所指" => Some("clearthat"),
        "clearthese" | "清理附近" => Some("clearthese"),
        "clearall" | "清理全部" => Some("clearall"),
        "pos" | "坐标" => Some("pos"),
        "create" | "创建" => Some("create"),
        "objectives" | "目标集" => Some("objectives"),
        "players" | "玩家分数" => Some("players"),
        "display" | "显示" => Some("display"),
        "displayautoupdate" | "自动更新显示名" => Some("displayautoupdate"),
        "rendertype" | "渲染类型" => Some("rendertype"),
        "numberformat" | "数字格式" => Some("numberformat"),
